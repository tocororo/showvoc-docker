...
Tags identify a specific release (i.e. version) of ShowVoc, while the tag `latest` is reference to the latest release (currently, `2.0.0`).
...
* issue the following command
  ...
  where `<version>` is the version number (e.g. `2.0.0`)
